...
③ All questions, the case questions within the pattern book, storage of learning records,
and the Daily Ranking require signing in. Personal data is collected **only when you create
an account**. The Service contains no payment functionality.
...
- **Display Name**: a name generated automatically by the Company to identify a Member on
  the Daily Ranking. Users cannot enter or change it, and it contains no personal data such
  as a real name or email address.
...
① When a Member takes part in the Daily Ranking, **their Display Name, that day's score,
and rank become visible to other users.**
...
The Company does not provide users' personal data to third parties, except where required by
lawful process from investigative or other competent authorities. Items shown to other users
on the Daily Ranking are governed by Article 3-2.
...
⑤ A Daily Ranking entry is submitted once per day and cannot be modified. If you wish to
delete such a record, you may do so by deleting your account.
...
① This Policy takes effect on July 30, 2026.

② This amendment was made before the Service's public launch; no user was subject to this
Policy before the effective date.

③ Principal changes: the Service is referred to as ChartDraw; the scope available without an
account is specified (Article 1); Daily Ranking records and the Display Name are added to the
items collected (Article 2); information visible to other users is newly stated (Article 3-2);
destruction of ranking records and related user rights are specified (Articles 4 and 8).
`
...
export const CHART_DRAW_PRIVACY_EN = [
  ...
  },
  {
    ...
    summary: 'Daily Ranking records and Display Name added · information visible to other users · Service referred to as ChartDraw',
    body: V1_1,
  },
]
